...
int main(void) {
  ...
  printf("hdate1 day : %d, month : %d, year : %d, yday : %d \n", hiredate1.day, hiredate1.month, hiredate1.year, hiredate1.yearday);

  hiredate2.year = 2023;
  hiredate2.day = 6;
  hiredate2.month = 8;
  day_of_year(&hiredate2);
  printf("hdate2 day : %d, month : %d, year : %d, yday : %d \n", hiredate2.day, hiredate2.month, hiredate2.year, hiredate2.yearday);
  return 0;
}
